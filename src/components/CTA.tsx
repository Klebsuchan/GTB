  ...
  return (
    <section className="w-full">
      <motion.div 
        ...
        className="bg-gradient-to-r from-primary to-primary-dark border border-primary-light/50 rounded-[2rem] p-6 sm:p-8 md:p-16 flex flex-col md:flex-row items-center justify-between shadow-2xl relative overflow-hidden"
      >
        ...
        <div className="mb-10 md:mb-0 md:mr-10 flex-1 relative z-10">
          <div className="bg-white dark:bg-secondary-dark/30 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 border border-white/20 backdrop-blur-sm shadow-inner">
        ...
        <div className="w-full md:w-auto shrink-0 flex flex-col items-center md:items-end relative z-10">
          <motion.a 
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-white dark:bg-secondary-dark text-slate-900 dark:text-white px-10 py-6 rounded-2xl font-bold text-xl hover:bg-slate-100 dark:bg-secondary-light transition-all shadow-xl"
          >
            INICIAR ATENDIMENTO
